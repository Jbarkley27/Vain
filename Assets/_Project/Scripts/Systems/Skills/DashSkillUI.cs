...
public class DashSkillUI : MonoBehaviour
{
    ...
    public void BeginRegeneration()
    {
        ...
        slider.DOValue(1, StatManager.Instance.GetDashRegenStat())
            .SetEase(Ease.Linear)
            .OnComplete(() =>
            {
                ...
                isRecharging = false;
                isReady = true;
                GlobalDataStore.Instance.PlayerMovement.CanDash = true;
            });
    }
}